 ...
 */
@Entity
public class ReformeItem implements Serializable {
    ...
    @ManyToOne
    private EntiteAdministrative eaCedant;
    @ManyToOne
    private Utilisateur utilisateurCedant;
    ...
    public boolean equals(Object object) {
        ...
        ReformeItem other = (ReformeItem) object;
