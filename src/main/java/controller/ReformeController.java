...
public class ReformeController implements Serializable {
    ...
    @EJB
    private service.ReformeFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("ReformeCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("ReformeUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("ReformeDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Reforme getReforme(java.lang.Long id) {
