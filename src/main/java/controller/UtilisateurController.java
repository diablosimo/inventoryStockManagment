...
public class UtilisateurController implements Serializable {
    ...
    public void seConnecter() throws IOException {
        ...
        if (res <= 0) {
            selected=null;
            JsfUtil.addErrorMessage("connexion echouée");
        } else {
    ...
    public void seDeconnecter() throws IOException {
        ...
        selected = null;
        SessionUtil.redirect("/inventoryStockManagment/faces/utilisateur/UserLogin.xhtml");
    }

    public Utilisateur getConnectedUser() {
        connectedUser= SessionUtil.getConnectedUser();
        System.out.println("connectedUserController=>"+connectedUser);
